    ...
    <div className="flex flex-col gap-6 font-sans animate-fadeIn pb-12">
      ...
      <div className="flex flex-col md:flex-row md:items-center justify-between gap-4 pb-4 border-b border-slate-800">
        ...
        <div className="flex flex-wrap items-center gap-2.5">
          ...
          <button
            ...
            className="flex items-center gap-2 px-3.5 py-2 bg-slate-900 hover:bg-slate-800 text-slate-200 border border-slate-700 text-xs font-bold rounded-xl transition cursor-pointer"
          >
              ...
              {filteredEntries.length > 0 ? (
                filteredEntries.map((e) => (
                  <tr key={e.id} className="hover:bg-slate-800/40 transition">
                    ...
                    <td className="py-3 px-4 max-w-xs truncate text-slate-400 font-sans text-xs" title={e.remarks}>
                      {e.remarks || "-"}
                    </td>
                    <td className="py-3 px-3 text-center whitespace-nowrap">
                      {e.isAutoFilled ? (
      ...
      {showExportModal && (
        <div className="fixed inset-0 bg-slate-950/80 backdrop-blur-md z-50 flex items-center justify-center p-4">
          <div className="bg-slate-900 border border-slate-800 rounded-3xl max-w-2xl w-full p-6 space-y-5 shadow-2xl animate-fadeIn">
            <div className="flex items-center justify-between pb-3 border-b border-slate-800">
              <div className="flex items-center gap-2">
                <FileSpreadsheet className="w-5 h-5 text-emerald-400" />
                <h3 className="text-lg font-bold text-white">Logbook Export & Third-Party Sync</h3>
              </div>
              <button
            ...
            <div className="flex p-1 bg-slate-950 border border-slate-800 rounded-xl text-xs font-bold">
              {[
            ...
            {exportFormat !== "api_json" ? (
              <div className="space-y-4">
                ...
                <div className="bg-slate-950/80 p-3 rounded-xl border border-slate-800 max-h-48 overflow-y-auto font-mono text-[10px] text-slate-400 select-all scrollbar-thin">
                ...
                <div className="flex items-center justify-between pt-2">
                  ...
                  <button
                    ...
                    className="flex items-center gap-2 px-4 py-2 bg-emerald-600 hover:bg-emerald-500 text-white rounded-xl text-xs font-bold shadow-lg shadow-emerald-600/20 transition cursor-pointer"
                  >
      ...
      {isAddModalOpen && (
        <div className="fixed inset-0 bg-slate-950/80 backdrop-blur-md z-50 flex items-center justify-center p-4">
          <form
            ...
            className="bg-slate-900 border border-slate-800 rounded-3xl max-w-xl w-full p-6 space-y-4 shadow-2xl animate-fadeIn"
          >
            <div className="flex items-center justify-between pb-3 border-b border-slate-800">
            ...
            <div className="grid grid-cols-2 sm:grid-cols-3 gap-3 text-xs">
              <div>
                <label className="text-[10px] text-slate-400 block font-bold mb-1 uppercase">Date</label>
                <input
                  type="date"
                  value={formData.date || ""}
              ...
              <div>
                <label className="text-[10px] text-slate-400 block font-bold mb-1 uppercase">Flight #</label>
                <input
                  type="text"
              ...
              <div>
                <label className="text-[10px] text-slate-400 block font-bold mb-1 uppercase">Tail #</label>
                <input
                  type="text"
              ...
              <div>
                <label className="text-[10px] text-slate-400 block font-bold mb-1 uppercase">Aircraft Type</label>
                <input
                  type="text"
              ...
              <div>
                <label className="text-[10px] text-slate-400 block font-bold mb-1 uppercase">Dep Station</label>
                <input
                  type="text"
                  value={formData.depAirport || ""}
                  onChange={(e) => setFormData({ ...formData, depAirport: e.target.value })}
                  className="w-full bg-slate-950 border border-slate-800 rounded-xl px-3 py-2 text-slate-200 font-mono uppercase focus:outline-none focus:border-indigo-500"
                  required
                />
              </div>

              <div>
                <label className="text-[10px] text-slate-400 block font-bold mb-1 uppercase">Arr Station</label>
                <input
                  type="text"
              ...
              <div>
                <label className="text-[10px] text-slate-400 block font-bold mb-1 uppercase">Out Time (HHMM)</label>
                <input
                  type="text"
              ...
              <div>
                <label className="text-[10px] text-slate-400 block font-bold mb-1 uppercase">In Time (HHMM)</label>
                <input
                  type="text"
              ...
              <div>
                <label className="text-[10px] text-slate-400 block font-bold mb-1 uppercase">Block Mins</label>
                <input
                  type="number"
              ...
              <div>
                <label className="text-[10px] text-slate-400 block font-bold mb-1 uppercase">PIC Mins</label>
                <input
                  type="number"
              ...
              <div>
                <label className="text-[10px] text-slate-400 block font-bold mb-1 uppercase">SIC Mins</label>
                <input
                  type="number"
              ...
              <div>
                <label className="text-[10px] text-slate-400 block font-bold mb-1 uppercase">Night Mins</label>
                <input
                  type="number"
            ...
            <div>
              <label className="text-[10px] text-slate-400 block font-bold mb-1 uppercase">Remarks / Notes</label>
              <textarea
                value={formData.remarks || ""}
                onChange={(e) => setFormData({ ...formData, remarks: e.target.value })}
                className="w-full bg-slate-950 border border-slate-800 rounded-xl px-3 py-2 text-xs text-slate-200 font-sans focus:outline-none focus:border-indigo-500 h-20"
            ...
            <div className="flex justify-end gap-3 pt-3 border-t border-slate-800">
              ...
              <button
                type="submit"
                className="px-5 py-2 bg-indigo-600 hover:bg-indigo-500 text-white rounded-xl text-xs font-bold transition shadow-lg shadow-indigo-600/20 cursor-pointer"
              >
